...
var Winter = {
	...
	NS : function(ns) {
		...
		var levels = ns.split(".");
		var nsobj = Winter;
		for ( var i = (levels[0] == "Winter") ? 1 : 0; i < levels.length; ++i) {
	...
	progressBar : function() {
		$(
				"<div id='myCover'></div><div id='loadimg'><img src='./themes/default/images/apploading.gif'/></div>")
				.appendTo('body');
		...
		$('#loadimg')
				.css(
						{
							'position' : 'absolute',
							'background' : 'url(themes/default/images/app-icloud.png) no-repeat center center',
							'z-index' : 10000,
							'width' : '256px',
							'height' : '256px',
							'left' : (w - 256) / 2,
